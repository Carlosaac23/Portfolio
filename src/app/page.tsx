export default function HomePage() {
  return (
    <div className='flex flex-col gap-10 text-neutral-600 dark:text-neutral-50'>
      <h1 className='text-left text-neutral-950 dark:text-neutral-50 text-2xl'>Carlos Acosta</h1>
      <p className='text-left text-pretty max-sm:leading-loose'>
        I am a{' '}
        <a
        ...
        <em className='font-semibold text-neutral-950 dark:text-neutral-50'>special taste</em> for{' '}
        <a href='https://www.vercel.com' target='_blank' rel='noopener noreferrer' className='font-bold text-neutral-950 dark:text-neutral-50'>
          Vercel
        </a>{' '}
