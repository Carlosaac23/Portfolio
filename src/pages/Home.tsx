  ...
  return (
    <div className='flex flex-col gap-10 geistMono-Regular text-[#fafafa]'>
      ...
      <div className='grid gap-5 text-sm md:grid-cols-[1fr_1fr_1fr] max-sm:place-items-center'>
        <a title='A link to my GitHub' href='https://github.com/Carlosaac23' target='_blank' rel='noopener noreferrer'>
        ...
        <a title='A link to my personal X' href='https://x.com/Carlosaac23' target='_blank' rel='noopener noreferrer'>
          <div className='flex items-center p-3 justify-between bg-[#111111] border border-[#262626] hover:border-[#5a5a5a] duration-300 ease-button-ease rounded-md max-sm:w-52'>
        ...
        <a title='A link to my Linkedin' href='https://www.linkedin.com/in/carlos-acosta-7aa448263/' target='_blank' rel='noopener noreferrer'>
          <div className='flex items-center p-3 justify-between bg-[#111111] border border-[#262626] hover:border-[#5a5a5a] duration-300 ease-button-ease rounded-md max-sm:w-52'>
