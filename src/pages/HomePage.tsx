...
function HomePage() {
  ...
  return (
    <div className='flex flex-col gap-10 geistMono-regular text-[#fafafa]'>
      <p className='text-left text-2xl text-[#fafafa]'>{t('presentation')} 👋🏻</p>
      ...
      <div className='grid md:grid-cols-[1fr_1fr_1fr] gap-5 text-[14px]'>
        <a href='https://github.com/Carlosaac23' target='_blank'>
          <div className='flex items-center p-3 justify-between bg-[#0a0a0a] border border-[#27272a] rounded-lg hover:border-[#52525b] transition-all duration-300'>
