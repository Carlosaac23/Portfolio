    ...
    <div className='flex flex-col gap-10 geistMono-Regular text-white'>
      ...
      <div className='flex flex-col gap-5'>
        <div className='flex w-[100%] justify-between gap-5'>
          <img src='images/vertical-2.webp' alt='' className='w-[35%] rounde-md' />
          <img src='/images/horizontal-2.webp' alt='' className='w-[65%] rounded-md' />
        </div>
        <div className='flex w-[100%] justify-between gap-5'>
          <img src='/images/horizontal-1.webp' alt='' className='w-[65%] rounded-md' />
          <img src='/images/vertical-1.webp' alt='' className='w-[35%] rounde-md' />
        </div>
      </div>
